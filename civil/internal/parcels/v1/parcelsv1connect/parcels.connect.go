...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/civil-labs/civil-api-go/civil/internal/parcels/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	ParcelsServiceName = "civil.internal.parcels.v1.ParcelsService"
)
...
const (
	...
	ParcelsServiceGetParcelAttributeProcedure = "/civil.internal.parcels.v1.ParcelsService/GetParcelAttribute"
)

// ParcelsServiceClient is a client for the civil.internal.parcels.v1.ParcelsService service.
...
// NewParcelsServiceClient constructs a client for the civil.internal.parcels.v1.ParcelsService
...
func NewParcelsServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) ParcelsServiceClient {
	...
	parcelsServiceMethods := v1.File_civil_internal_parcels_v1_parcels_proto.Services().ByName("ParcelsService").Methods()
...
// GetParcelAttribute calls civil.internal.parcels.v1.ParcelsService.GetParcelAttribute.
...
// ParcelsServiceHandler is an implementation of the civil.internal.parcels.v1.ParcelsService
// service.
...
func NewParcelsServiceHandler(svc ParcelsServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/civil.internal.parcels.v1.ParcelsService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedParcelsServiceHandler) GetParcelAttribute(context.Context, *connect.Request[v1.GetParcelAttributeRequest]) (*connect.Response[v1.GetParcelAttributeResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("civil.internal.parcels.v1.ParcelsService.GetParcelAttribute is not implemented"))
}
