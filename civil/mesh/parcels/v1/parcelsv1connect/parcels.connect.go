...
const (
	...
	// RPC.
	ParcelsServiceGetParcelProcedure = "/civil.mesh.parcels.v1.ParcelsService/GetParcel"
	// ParcelsServiceGetParcelAttributesProcedure is the fully-qualified name of the ParcelsService's
	// GetParcelAttributes RPC.
	ParcelsServiceGetParcelAttributesProcedure = "/civil.mesh.parcels.v1.ParcelsService/GetParcelAttributes"
	// ParcelsServiceGetNumericalStatsProcedure is the fully-qualified name of the ParcelsService's
	// GetNumericalStats RPC.
	ParcelsServiceGetNumericalStatsProcedure = "/civil.mesh.parcels.v1.ParcelsService/GetNumericalStats"
	// ParcelsServiceGetCategoricalStatsProcedure is the fully-qualified name of the ParcelsService's
	// GetCategoricalStats RPC.
	ParcelsServiceGetCategoricalStatsProcedure = "/civil.mesh.parcels.v1.ParcelsService/GetCategoricalStats"
	...
	ParcelsServiceUpdateParcelsAttributeProcedure = "/civil.mesh.parcels.v1.ParcelsService/UpdateParcelsAttribute"
)
...
// GetParcel calls civil.mesh.parcels.v1.ParcelsService.GetParcel.
...
// GetParcelAttributes calls civil.mesh.parcels.v1.ParcelsService.GetParcelAttributes.
...
// GetNumericalStats calls civil.mesh.parcels.v1.ParcelsService.GetNumericalStats.
...
// GetCategoricalStats calls civil.mesh.parcels.v1.ParcelsService.GetCategoricalStats.
...
// UpdateParcelsAttribute calls civil.mesh.parcels.v1.ParcelsService.UpdateParcelsAttribute.
...
func (UnimplementedParcelsServiceHandler) GetParcel(context.Context, *connect.Request[v1.GetParcelRequest]) (*connect.Response[v1.GetParcelResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("civil.mesh.parcels.v1.ParcelsService.GetParcel is not implemented"))
}
...
func (UnimplementedParcelsServiceHandler) GetParcelAttributes(context.Context, *connect.Request[v1.GetParcelAttributesRequest]) (*connect.Response[v1.GetParcelAttributesResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("civil.mesh.parcels.v1.ParcelsService.GetParcelAttributes is not implemented"))
}
...
func (UnimplementedParcelsServiceHandler) GetNumericalStats(context.Context, *connect.Request[v1.GetNumericalStatsRequest]) (*connect.Response[v1.GetNumericalStatsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("civil.mesh.parcels.v1.ParcelsService.GetNumericalStats is not implemented"))
}
...
func (UnimplementedParcelsServiceHandler) GetCategoricalStats(context.Context, *connect.Request[v1.GetCategoricalStatsRequest]) (*connect.Response[v1.GetCategoricalStatsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("civil.mesh.parcels.v1.ParcelsService.GetCategoricalStats is not implemented"))
}
...
func (UnimplementedParcelsServiceHandler) UpdateParcelsAttribute(context.Context, *connect.Request[v1.UpdateParcelsAttributeRequest]) (*connect.Response[v1.UpdateParcelsAttributeResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("civil.mesh.parcels.v1.ParcelsService.UpdateParcelsAttribute is not implemented"))
}
