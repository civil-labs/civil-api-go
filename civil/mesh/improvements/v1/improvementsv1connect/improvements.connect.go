...
const (
	...
	ImprovementServiceName = "civil.mesh.improvements.v1.ImprovementService"
)
...
const (
	...
	ImprovementServiceGetImprovementTypesProcedure = "/civil.mesh.improvements.v1.ImprovementService/GetImprovementTypes"
	...
	ImprovementServiceGetImprovementConditionsProcedure = "/civil.mesh.improvements.v1.ImprovementService/GetImprovementConditions"
)

// ImprovementServiceClient is a client for the civil.mesh.improvements.v1.ImprovementService
// service.
...
// civil.mesh.improvements.v1.ImprovementService service. By default, it uses the Connect protocol
...
func NewImprovementServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) ImprovementServiceClient {
	...
	improvementServiceMethods := v1.File_civil_mesh_improvements_v1_improvements_proto.Services().ByName("ImprovementService").Methods()
...
// GetImprovementTypes calls civil.mesh.improvements.v1.ImprovementService.GetImprovementTypes.
...
// civil.mesh.improvements.v1.ImprovementService.GetImprovementConditions.
...
// civil.mesh.improvements.v1.ImprovementService service.
...
func NewImprovementServiceHandler(svc ImprovementServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/civil.mesh.improvements.v1.ImprovementService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedImprovementServiceHandler) GetImprovementTypes(context.Context, *connect.Request[v1.GetImprovementTypesRequest]) (*connect.Response[v1.GetImprovementTypesResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("civil.mesh.improvements.v1.ImprovementService.GetImprovementTypes is not implemented"))
}
...
func (UnimplementedImprovementServiceHandler) GetImprovementConditions(context.Context, *connect.Request[v1.GetImprovementConditionsRequest]) (*connect.Response[v1.GetImprovementConditionsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("civil.mesh.improvements.v1.ImprovementService.GetImprovementConditions is not implemented"))
}
